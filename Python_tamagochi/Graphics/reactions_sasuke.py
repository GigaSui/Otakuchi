...
class ReactionsSasuke:
    ...
    def __init__(self):
        ...
        if self.reacts == 1:
            ...
            # Load a image
            self.img_path = "assets/Sasuke_hungry.png"
        ...
        if self.reacts == 2:
           ...
           # Load a image
           self.img_path2 = "assets/Sasuke_dirty.png"
        ...
        if self.reacts == 3:
            ...
            # Load a image
            self.img_path3 = "assets/Sasuke_sick.png"
        ...
        if self.reacts == 4:
            ...
            # Load a image
            self.img_path4 = "assets/Sasuke_play.png"
