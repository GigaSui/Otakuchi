...
class ReactionsNaruto:
    ...
    def __init__(self):
        ...
        if self.reacts == 1:
            ...
            # Load a image
            self.img_path = "assets/Naruto_hungry.png"
        ...
        if self.reacts == 2:
           ...
           # Load a image
           self.img_path2 = "assets/Naruto_dirty.png"
        ...
        if self.reacts == 3:
            ...
            # Load a image
            self.img_path3 = "assets/Naruto_sick.png"
        ...
        if self.reacts == 4:
            ...
            # Load a image
            self.img_path4 = "assets/Naruto_play.png"
