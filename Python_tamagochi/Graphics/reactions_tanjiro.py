...
class ReactionsTanjiro:
    ...
    def __init__(self):
        ...
        if self.reacts == 1:
            ...
            # Load a image
            self.img_path = "assets/Tanjiro_hungry.png"
        ...
        if self.reacts == 2:
           ...
           # Load a image
           self.img_path2 = "assets/Tanjiro_dirty.png"
        ...
        if self.reacts == 3:
            ...
            # Load a image
            self.img_path3 = "assets/Tanjiro_sick.png"
        ...
        if self.reacts == 4:
            ...
            # Load a image
            self.img_path4 = "assets/Tanjiro_play.png"
